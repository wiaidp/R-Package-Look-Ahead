...
#            strong zero-shrinkage. This is also the point at which the sign on V1 
#            is switched: the tension between target correlation and constraint 
#            forces the predictor to change sign (become definitively unusable)
#            in order to accord with the misspecified slope beta for that particular 
#            regularization weight lambda. Otherwise, b is a mix of
