...
# one of the available 12 degrees of freedom: 11 degrees of freedom are left for 
# optimization.

# Type I with h=12:
# Strong regularization implies that all degrees of freedom are eaten-up by the 
# 12-dimensional consztraint system of PCS type III.
...
# ════════════════════════════════════════════════════════════════════
# EXERCISE 2: As Exercise 1 but Medium Regularization
# ════════════════════════════════════════════════════════════════════
...
# Smaller Lambda is sufficiently small to allow maximization of the target correlation, addressing the 
# PCS constraints in a more flexible way
lambda<-20


# ─────────────────────────────────────────────────────────────────────
# 2.1 PCS Optimisation over the Slope Grid
# ─────────────────────────────────────────────────────────────────────
...
# ════════════════════════════════════════════════════════════════════
# EXERCISE 3: As Exercise 1 but Type III) PCS based on PCS_func()
# ════════════════════════════════════════════════════════════════════
